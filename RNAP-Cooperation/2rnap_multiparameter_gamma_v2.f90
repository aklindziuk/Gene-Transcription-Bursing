...
open(5, file = "results_yinf.dat", status = "replace")
...
print*, kfs(h)/kns(h), var2/mean, fano_yinf, mean, n_inf
write(5, *) kfs(h)/kns(h), ",", var2/mean,",",fano_yinf, ",", mean, ",", n_inf
